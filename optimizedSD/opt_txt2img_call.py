...
import sys
sys.path.append("/home/rdp455/BLIP/stable-diffusion/optimizedSD")
...
class txt2img():
    def __init__(self,
                #  outdir:str="outputs/txt2img-samples",
                 ...
                 config:str="/home/rdp455/BLIP/stable-diffusion/optimizedSD/v1-inference.yaml",
                 ckpt:str="/home/rdp455/BLIP/stable-diffusion/sd-v1-4.ckpt",
                 seed:int=42,
        ...
        self.modelCS.eval()
        self.modelCS.cond_stage_model.device = device
        ...
        if device != "cpu" and self.precision == "autocast":
            self.model.half()
            self.modelCS.half()
            ...
            with self.precision_scope("cuda"):
                ...
                for n in trange(self.n_iter, desc="Sampling"):
                    for prompts in tqdm(data, desc="data"):
                        ...
                        samples_ddim =  self.model.sample(S=self.ddim_steps,
                                        conditioning=c,
                                        seed=self.seed,
                                        shape=shape,
                                        verbose=False,
                                        ...
                                        eta=self.ddim_eta,
                                        x_T=self.start_code,
                                        sampler="plms" if self.plms else "ddim"
                                        )
                        
                        self.modelFS.to(self.device)

                        x_samples_ddim = self.modelFS.decode_first_stage(samples_ddim)
